...
<head>
    ...
    <link rel="stylesheet" href="css/resource-style.css">
...
<body>
    ...
    <section class="hero">
        ...
        <p id="loadingInstruction">Loading video...</p>

        <img id="placeholderImage" src="img/placeholder.jpg" alt="Video Placeholder" />
    ...
    <div class="resources-container">
        <div class="left-section">
            <div class="category-title">Videos</div>
        ...
        <div class="right-section topic-list">
            <a onclick="changeTopic('gettingStarted')">Getting Started</a>
            <a onclick="changeTopic('registry')">Registry of Companies and Business Names</a>
            <a onclick="changeTopic('revenue')">Revenue Division</a>
        </div>
    </div>
    ...
    <script src="Javascript/Resource-script.js"></script>
