...
<body>
    ...
    <section class="latest-news-full">
        <div class="latest-news-container">
            <div class="latest-news-image">
                <img src="img/MOFE_Building.jpg" alt="Latest News Image" />
            </div>

            <div class="latest-news-content">
                <div class="latest-news-header">
                    <h2>Latest News</h2>
                    <div class="categories" id="latest-news-categories">

                    </div>
                </div>
                <div class="news-title">Latest News Title</div>
                <div class="news-description">
                    This is the latest news description. It provides a brief overview of the news item.
                </div>
                <div class="news-date">Published: October 10, 2023</div>
            </div>
        </div>
    </section>
    ...
    <div class="news-section">
        <div class="news-grid-container">
            ...
            <div class="grid-navigation">
                <button class="grid-prev" disabled>
                    <i class="fas fa-chevron-left"></i>
                </button>
                <div class="grid-pagination"></div>
                <button class="grid-next">
    ...
    <script src="Javascript/News-script.js"></script>
